...
{ 
  ...
  {
    // Euler integrator
    NewPositions[i].x=Positions[i].x+Velocities[i].x*Deltat+(Forces[i].x/2)*SQR(Deltat);
    NewPositions[i].y=Positions[i].y+Velocities[i].y*Deltat+(Forces[i].y/2)*SQR(Deltat);
    NewPositions[i].z=Positions[i].z+Velocities[i].z*Deltat+(Forces[i].z/2)*SQR(Deltat);
 
    Velocities[i].x=Velocities[i].x+Forces[i].x*Deltat;
    Velocities[i].y=Velocities[i].y+Forces[i].x*Deltat;
    Velocities[i].z=Velocities[i].z+Forces[i].x*Deltat;
    ...
    Velocities[i].x=Velocities[i].x+((Forces[i].x+Forces[i].x)/2)*Deltat;
    Velocities[i].y=Velocities[i].y+((Forces[i].y+Forces[i].y)/2)*Deltat;
    Velocities[i].z=Velocities[i].z+((Forces[i].z+Forces[i].z)/2)*Deltat;
    */
